    ...
    return (
      ...
      <div className="row flex-xl-nowrap justify-content-center">
        ...
        <main className="col-lg-11 col-xl-9 col-xxl-8 py-md-3 ps-xl-5 text-center" role="main">
          ...
          subtitle={<div>A virtual-reality cooking game &nbsp;<FontAwesomeIcon icon={faUtensils}/>.</div>}
          media={<div  className="ratio ratio-16x9 my-3"><iframe src="https://www.youtube.com/embed/3EUrt8cDPWE" title="EPFL VR Project - Hunger Slayer: Grand Banquet" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>}>
          ...
          subtitle={<div>Forest SaVR is a Virtual-Reality application to raise awareness of deforestation&nbsp;<FontAwesomeIcon icon={faTree}/>.</div>}
          id={"forest-savr"} media={<div  className="ratio ratio-16x9 my-3"><iframe src="https://www.youtube.com/embed/E93NYJ476wk" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>}>
            ...
            This project is made as part of the <a href="https://vrarlab.uni.lu/">VR/AR LAB</a> with Jean Botev and is developed with <a href="https://unity.com/">Unity <i className="fab fa-unity"></i></a>.
          ...
          subtitle={"Proof Guide is a responsive website with interactive lessons on mathematical proofs and their applications."}
          ...
          subtitle={"A visual user interface for a concept recognition system in European and national legislation"}
